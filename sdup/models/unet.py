...
class UNet3DConditionModel(ModelMixin, ConfigMixin, UNet2DConditionLoadersMixin):
    ...
    def forward(
        ...
        Returns:
            [`~models.unet_2d_condition.UNet3DConditionOutput`] or `tuple`:
                If `return_dict` is True, an [`~models.unet_2d_condition.UNet3DConditionOutput`] is returned, otherwise
    ...
    @classmethod
    def from_pretrained_2d(cls, pretrained_model_path, subfolder=None, config_3d=None):
        ...
        if config_3d is not None:
            config.update(config_3d)
        else:
        ...
        state_dict = load_safetensor_file(model_file)
    ...
    @classmethod
    def from_pretrained_v2(cls, pretrained_model_path, subfolder=None, config_3d=None):
        if subfolder is not None:
            pretrained_model_path = os.path.join(pretrained_model_path, subfolder)
    ...
    @classmethod
    def from_pretrained_v3(cls, pretrained_model_path, subfolder=None, config_3d=None):
        if subfolder is not None:
            pretrained_model_path = os.path.join(pretrained_model_path, subfolder)
